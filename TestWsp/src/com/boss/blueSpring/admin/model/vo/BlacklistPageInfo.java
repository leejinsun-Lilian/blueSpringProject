...
public class BlacklistPageInfo {
	...
	public BlacklistPageInfo(int currentPage, int listCount) {
		super();
	...
	public BlacklistPageInfo(int currentPage, int listCount, int limit, int pageSize) {
		super();
		this.currentPage = currentPage;
		this.listCount = listCount;
		this.limit = limit;
	...
	public String toString() {
		return "BlacklistPageInfo [currentPage=" + currentPage + ", listCount=" + listCount + ", limit=" + limit
