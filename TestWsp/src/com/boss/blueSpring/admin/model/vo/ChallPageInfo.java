...
public class ChallPageInfo {
	...
	public ChallPageInfo(int currentPage, int listCount) {
		super();
	...
	public ChallPageInfo(int currentPage, int listCount, int limit, int pageSize) {
		super();
		this.currentPage = currentPage;
		this.listCount = listCount;
		this.limit = limit;
	...
	public String toString() {
		return "ChallPageInfo [currentPage=" + currentPage + ", listCount=" + listCount + ", limit=" + limit
