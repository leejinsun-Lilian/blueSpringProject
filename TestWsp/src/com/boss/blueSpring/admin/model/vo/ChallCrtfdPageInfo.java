...
public class ChallCrtfdPageInfo {
	...
	public ChallCrtfdPageInfo(int currentPage, int listCount) {
		super();
	...
	public ChallCrtfdPageInfo(int currentPage, int listCount, int limit, int pageSize) {
		super();
		this.currentPage = currentPage;
		this.listCount = listCount;
		this.limit = limit;
	...
	public String toString() {
		return "ChallCrtfdPageInfo [currentPage=" + currentPage + ", listCount=" + listCount + ", limit=" + limit
